<?php /* Smarty version 2.6.13, created on 2012-06-05 10:23:54
...
, <span style="color:yellow"> <?php echo $this->_tpl_vars['verified']; ?>
                ...
                <ul id="menu" class="menu main-nav" >
                    ...
                    <li><a href="https://login.marlboro.co.id/Templates/Referfriends.aspx?id=<?php echo $this->_tpl_vars['register_id']; ?>
&promoref=refer_friend">Refer a Friend</a></li>
