...
class ultimate_racing_model extends SQLData{
	...
	function calculate_result($session_id,$race){
		...
		//simulate the race
		$simulation = $this->simulate_race($user1_stats,$user2_stats,$circuit['config'],$circuit['laps'],$user1_total_race,$user2_total_race,$user1_total_wins,$user2_total_wins,$ultimate_id);
	...
	function simulate_race($user1,$user2,$tracks,$laps,$user1_total_race,$user2_total_race,$user1_total_wins=0,$user2_total_wins=0,$ultimate_id=999){
		global $WIN_PENALTY;
		$n = sizeof($tracks);
		$total_events = $n*$laps;
		...
		$range_persentase_lose = $ultimate_car['persentase_lose'];
