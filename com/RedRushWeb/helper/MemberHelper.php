	...
	function insert_data_from_mop($profile){
		...
		if($row['email']==$email){
			...
			if(strlen($row['register_id'])<=1&&intval($row['mobile_type'])!=1){
				...
				kana_member(register_id,name,nickname,email,register_date,username,city,sex,birthday,img,last_name,StreetName,MobilePhone,last_login,n_status,login_count,verified)
				VALUES ('".$pro['RegistrationID']."','".$pro['FirstName']."','','{$email}',NOW(),'".$pro['Login']."','".$pro['CityID']."','".$pro['Gender']."','".$birthday."','$avatar','".$pro['LastName']."','".$streetName."','".$mobilePhone."',$last_login,'$n_status','1','$verified');";
			...
			//-->
				$sql = "INSERT IGNORE INTO 
				kana_member(register_id,name,nickname,email,register_date,username,city,sex,birthday,img,last_name,StreetName,MobilePhone,last_login,n_status,login_count,verified)
				VALUES ('".$pro['RegistrationID']."','".$pro['FirstName']."','{$pro['OtherName']}','{$email}',NOW(),'".$pro['Login']."','".$pro['CityID']."','".$pro['Gender']."','".$birthday."','$avatar','".$pro['LastName']."','".$streetName."','".$mobilePhone."',$last_login,'$n_status','1','$verified');";
